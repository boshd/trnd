...
@objc public class RecordAR: ARView {
    ...
    func setup() {
        ...
        /*NotificationCenter.default.addObserver(self, selector: #selector(appWillEnterBackground), name: Notification.Name.UIApplication.willResignActiveNotification, object: nil)*/
    }
